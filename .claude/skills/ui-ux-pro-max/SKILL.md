---
name: ui-ux-pro-max
description: AI-powered design intelligence with 84 UI styles, 192 color palettes, 74 font pairings, 98 UX guidelines, and 25 chart types across 22 tech stacks. Use when designing UI, choosing color palettes, typography pairings, or applying UX/accessibility guidelines. Data lives in ./data/*.csv; query it with ./scripts/search.py.
license: MIT
---
# {{TITLE}}
